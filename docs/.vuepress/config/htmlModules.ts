...
const htmlModule: VdoingThemeConfig["htmlModules"] = {
  ...
  pageB: `<hr> <p>ここからはGoogleの広告になります。</p>
  <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6878702077547492"
    crossorigin="anonymous"></script>
<!-- colorpanda -->
<ins class="adsbygoogle"
    style="display:block"
    data-ad-client="ca-pub-6878702077547492"
    data-ad-slot="7708738471"
    data-ad-format="auto"
    data-full-width-responsive="true"></ins>
<script>
    (adsbygoogle = window.adsbygoogle || []).push({});
